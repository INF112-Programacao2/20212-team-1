...
bool Player::walk(int direcao, Map &mapa){
    ...
    if(direcao == -1){
        ...
        al_draw_bitmap_region(_image, this->_numPasso * this->_tam_x, direcao * this->_tam_y,this->_tam_x, this->_tam_y,_position.get_x() * this->_tamPixels,_position.get_y() * this->_tamPixels, 0);
    }
